...
public class UtentiController 
{
	...
	@GetMapping("elencoutentien")
	public String elencoUtentien (Model model)
	{
		model.addAttribute("elencoutenti", du.leggiTutti());
		model.addAttribute("proviamo","sto funzionandooooooo");
		return "/utenti/elencoutentien.jsp";
	}
	@GetMapping("elencoutentifr")
	public String elencoUtentifr (Model model)
	{
		model.addAttribute("elencoutenti", du.leggiTutti());
		model.addAttribute("proviamo","sto funzionandooooooo");
		return "/utenti/elencoutentifr.jsp";
	}
